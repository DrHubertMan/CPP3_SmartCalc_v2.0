...
int s21::ViewCreditCalc::GetTerm() const noexcept {
    return mounth_->value();
}
...
void s21::ViewCreditCalc::SetDifMounthPay(int mounth, double pay) noexcept {
    diferent_pay_->append(QString::number(mounth) + ". Mounth: pay - " + QString::number(pay, 'f', 2));
}
...
void s21::ViewCreditCalc::InitLabel() {
    ...
    everymonth_pay_->setStyleSheet("background: #008080; color: white; font: 18pt");
    ...
    everymonth_pay_text_->setStyleSheet("background: #326759; color: white; font: 15pt");
    ...
    overpay_sum_text_->setStyleSheet("background: #326759; color: white; font: 15pt");
...
void s21::ViewCreditCalc::InitSpinBox() {
    ...
    credit_sum_->setValue(0);
    credit_sum_->setStyleSheet("background: #008080; color: white; font: 14pt");

    mounth_ = new QSpinBox();
    mounth_->setGeometry(10, 130, 250, 30);
    mounth_->setRange(0, 999);
    mounth_->setValue(0);
    mounth_->setStyleSheet("background: #008080; color: white; font: 14pt");

    double_percent_ = new QDoubleSpinBox();
    double_percent_->setGeometry(10, 210, 250, 30);
    double_percent_->setRange(0, 999);
    double_percent_->setValue(0);
    double_percent_->setStyleSheet("background: #008080; color: white; font: 14pt");
}
